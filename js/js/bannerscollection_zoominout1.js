/*
 * Zoom In/Out Sliders Full Collection  v3.3
 *
...
(function(e) {
    ...
    function ba(a, b, c, p, f, n, m, h, g, l, r, t, s, q, w, u, v, y, d, D, E, z) {
        ...
        if (b.origWidth != responsiveWidth || b.width100Proc) {
            ...
            m.width(b.width);
            m.height(b.height);
            f.css("margin-top", parseInt((b.height - v.height()) / 1.5, 10) + "px");
    ...
    e.fn.bannerscollection_zoominout = function(a) {
        ...
        return this.each(function() {
            ...
            h.width(a.width);
            h.height(a.height);
            n.css("margin-top", parseInt((a.height - g.height()) / 1.04, 10) + "px");
            c = b.find("ul:first");
            d.total_images = 0;
            var z = c.children(),
                I, T = 0,
           ...
           a.showOnInitBottomNav && r.css("left", parseInt((f.width() - O) / 2, 10) + "px");
            // a.showOnInitBottomNav && r.css("left","0px");
